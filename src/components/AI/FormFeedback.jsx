  ...
  return (
    <div style={{ display: "grid", gap: "18px", width: "100%" }}>
      <div style={{ padding: "22px", borderRadius: "28px", background: "rgba(15, 18, 32, 0.92)", border: "1px solid rgba(81, 239, 183, 0.18)" }}>
        <p style={{ margin: 0, color: "#7b82a1", textTransform: "uppercase", fontSize: "0.75rem", letterSpacing: "0.18em" }}>FORM SCORE</p>
        <h2 style={{ margin: "10px 0 0", color: "#f8fafc", fontSize: "3rem" }}>{score}%</h2>
      </div>

      <div style={{ display: "grid", gap: "12px" }}>
        <p style={{ margin: 0, color: "#7b82a1", textTransform: "uppercase", fontSize: "0.78rem", letterSpacing: "0.16em" }}>Feedback</p>
        {feedback.length === 0 ? (
            ...
            return (
              <div
                ...
                style={{
                  ...
                  color: safeMessage.startsWith("Keep") || safeMessage.startsWith("Lower") ? "#fbbf24" : "#9ee7ff",
                }}
              >
